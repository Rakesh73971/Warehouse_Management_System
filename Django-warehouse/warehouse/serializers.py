...
class WarehouseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Warehouse
        fields = ['id','name','location','manager','manager_email','is_active','created_at']
...
class ZoneSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Zone
        fields = ['id','warehouse','warehouse_name','name','description','storage_type','storage_type_name']

class RackSerializer(serializers.ModelSerializer):
    zone_name = serializers.CharField(source='zone.name',read_only=True)
    class Meta:
        model = Rack
        fields = ['id','zone','zone_name','rack_code','max_capacity']
